 ...
 */ !(function (t) {
    ...
    function (t, e, n) {
        n(121), n(123), n(36), n(125), n(313), n(314), n(315), n(316), n(321), (t.exports = n(322));
    },
    // function (t, e, n) {
    //     "use strict";
    //     var r = n(5);
    ...
    function (t, e, n) {
        ...
        function _t(t) {
            ...
            var R,
                ...
                P = o && l(gt(o.target));
            if ((D ? ((R = L.limitAffectedElements), (N = P), (C = l(L))) : (N = C = l({ id: T, selector: O, selectorGuids: w })), o && S)) {
                var M = a && (C || !0 === S) ? [a] : d(P);
                if (C) {
                    if (S === G)
                                    ...
                                    function () {
                                        !(function (e) {
                                            ...
                                            var i = (function (t, e, n) {
                                                    if (
                                                        document.body.hasAttribute("data-wf-reduce-scroll-motion") &&
                                                        ("none" === document.body.getAttribute("data-wf-scroll-motion") || ("function" == typeof window.matchMedia && window.matchMedia("(prefers-reduced-motion: reduce)").matches))
                                                    )
                                                        return 0;
                                                    var r = 1;
                                                    return (
                    ...
                    i.el.off(v),
                        ...
                        u
                            ...
                            : (i.el.on("swipe" + v, N(i)),
                              ...
                              i.config.autoplay && !i.hasTimer && ((i.hasTimer = !0), (i.timerCount = 1), x(i)),
...
Webflow.require("ix2").init({
    events: {
        "e-7": {
            ...
            target: { id: "1397dc29-4b90-5603-178a-72d9f536c2dd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "1397dc29-4b90-5603-178a-72d9f536c2dd", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-8": {
            ...
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-3", affectedElements: {}, playInReverse: false, autoStopEventId: "e-7" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "1397dc29-4b90-5603-178a-72d9f536c2dd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "1397dc29-4b90-5603-178a-72d9f536c2dd", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-9": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "603c54506a6e6f0fc7a72068|8b907739-da24-bb4f-8339-989709267bbd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "603c54506a6e6f0fc7a72068|8b907739-da24-bb4f-8339-989709267bbd", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1615178039926,
        },
        "e-10": {
            id: "e-10",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-4", affectedElements: {}, playInReverse: false, autoStopEventId: "e-9" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "603c54506a6e6f0fc7a72068|8b907739-da24-bb4f-8339-989709267bbd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "603c54506a6e6f0fc7a72068|8b907739-da24-bb4f-8339-989709267bbd", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1615178039934,
        },
    },
    actionLists: {
        a: {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 1500,
                                target: { useEventTarget: true, id: "603c54506a6e6f0fc7a72068|e0b5a3e9-8a7b-e36c-a867-89dea88ecdfa" },
                                globalSwatchId: "",
                                rValue: 255,
                                bValue: 80,
                                gValue: 127,
                    ...
                    actionItems: [
                        {
                            id: "a-3-n",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "1397dc29-4b90-5603-178a-72d9f536c2dd" }, globalSwatchId: "d17e8458", rValue: 0, bValue: 0, gValue: 0, aValue: 1 },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: false,
            createdOn: 1615153855492,
        },
        "a-4": {
            id: "a-4",
                    ...
                    actionItems: [
                        {
                            id: "a-4-n",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "603c54506a6e6f0fc7a72068|8b907739-da24-bb4f-8339-989709267bbd" }, globalSwatchId: "" },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1615178144061,
        },
    },
    site: {
        mediaQueries: [
